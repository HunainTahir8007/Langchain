...
class summer(BaseModel):
    ...
    features : str = Field(description="Features of the phone")
    review : Optional[str] = Field("If any reviews are avaliable then givee ")
    contact : EmailStr = Field(description="Give me the eamil for the contch for any query")
